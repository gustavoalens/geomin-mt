                ...
                if (resultado_analise){ // confirmando analise dos dados
                    ...
                    for (var anot in resultado_analise[cod]){
                        ...
                        // gerando coluna para socioeconomico
                            ...
                            let ideb_inciais = check_float(resultado_analise[cod][anot]['socioeconomico'][13][0], 3)
                            let ideb_finais = check_float(resultado_analise[cod][anot]['socioeconomico'][14][0], 3)
